...
1.  Phase 1: Below are the candidates generated for the dataset shown above at different time steps of by implementing Random Walks and Markovian Clustering
...
2.  Phase 2: Phase 2 aims at filtering out the duplicate communitites and generates unique communities for a given dataset. The result generated by Phase 2 of the algorithm is as shown below:
...
3.  Phase 3: This phase of the algorithm focuses on comparing the communities generated at phase 2 and determining the extent of matching between them.
